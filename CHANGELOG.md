...
- **Repair Links open feedback** — Immediate “Opening…” spinner while catalog folder list builds off the main actor; pre-selected old folder scrolls into view; folder list sorted A–Z by full path.
