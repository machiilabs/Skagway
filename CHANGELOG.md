...
- **Fix: Show Inspector (⌘I) stall** — Hide was cheap; show took 2–3s because the Inspector host was evicted from the window and `layoutSubtreeIfNeeded` cold-laid-out the pane plus every cached Storyboard card. The host now parks in-window at last size (3↔4 reflow kept; no wall remount; 1164 range clamp stays).
