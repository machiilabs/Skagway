...
- **Repair Links open UX (large libraries)** — Sheet opens immediately on Repair Links… (no click freeze); in-sheet “Building folder list…” until the catalog is ready (Continue stays disabled). Pre-selected old folder scrolls into view; folder list sorted A–Z by full path.
