...
- **Storyboard collage click** — First plain click on a collage focuses/selects; a second plain click on the already-focused card seeks and plays from that frame without changing the collected set. ⌘/⇧/⌥ clicks still collect or exclusive-select without starting playback.
