...
- **Storyboard density no longer shrinks Normal below Compact** — Normal and Compact share gaps, card padding, and type size. When both fit the same number of columns, the cards match. Compact is smaller only when the pane fits more columns.
